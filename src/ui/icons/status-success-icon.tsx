...
const SvgStatusSuccessIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg width="1em" height="1em" viewBox="0 0 52 52" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g>
            <path
